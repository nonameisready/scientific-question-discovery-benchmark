...
components postdate the cutoff (Section~\ref{sec:threats}). Moreover,
Section~\ref{sec:judgeval} shows all absolute rates are
rater-relative: ``10/10 engaged'' is this instance's adjudicated
reading, made by the authors, not a rater-free fact. The pilot
