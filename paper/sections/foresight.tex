...
(39.2\% vs.\ 24.8\% answered, $p=0.02$---suggestive only; this
contrast does not survive the multiple-comparison correction of
Section~\ref{sec:threats}---and 12.8\% vs.\ 2.4\% refuted, $p=0.003$,
which does): phrasing a tension as a crisp either/or question makes it
