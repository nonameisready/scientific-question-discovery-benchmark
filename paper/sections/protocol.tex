...
are flagged. Every machine-assigned label then passes \emph{human
adjudication} under written guidelines (citation validity, the
engagement bar, the outcome/premise split), and the adjudication log is
released alongside the labels. No result enters the benchmark
unreviewed.
...
judging, adjudication, metrics, report---is identical for every
