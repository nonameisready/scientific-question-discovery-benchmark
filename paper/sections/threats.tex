...
contamination probe; and the decisive test is \emph{prospective}
...
\paragraph{Small $n$, one domain, self-evaluation.} Ten questions from
one system in one domain, evaluated by the group that built that system,
support no ranking claims---which is why the leaderboard ships
partially populated, the harness is public, and the paper's empirical
claim is deliberately modest (Section~\ref{sec:intro}). The protocol's
