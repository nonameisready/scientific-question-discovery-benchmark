...
be rebuilt from scratch with the staged scripts in `paper3/scripts/`.

| Path | Contents | Committed |
| --- | --- | --- |
| `raw/arxiv/` | arXiv astro-ph metadata shards, 2005–2025 (per category-year JSONL) | no (rebuild with `python -m paper3.pipeline.harvest`) |
...
and checked by `paper3/scripts/validate_isolation.py`.
