...
Produces:
- paper3/data/raw/corpus_classified.jsonl   (local, reproducible, not committed)
- paper3/data/corpus/subfield_year_stats.json
- paper3/data/corpus/corpus_manifest.json   (committed provenance record)
"""
...
from paper3.pipeline import corpus, subfields
...
def main() -> None:
    ...
    out = Path("paper3/data/corpus/corpus_manifest.json")
