...
Produces:
- paper3/data/labels/labels_v1.jsonl          (tier 1 + tier 2, committed)
- paper3/data/labels/labels_second_judge.jsonl (tier 3 sample, committed)
- paper3/data/labels/judge_agreement.json      (reliability report)
"""
...
from paper3.pipeline.llm import SECOND_JUDGE_MODEL

QUESTIONS = Path("paper3/data/questions/questions_v1.jsonl")
OUT = Path("paper3/data/labels/labels_v1.jsonl")
OUT2 = Path("paper3/data/labels/labels_second_judge.jsonl")
AGREEMENT = Path("paper3/data/labels/judge_agreement.json")
