...
Produces paper3/data/questions/questions_v1.jsonl (committed, frozen).
"""
...
from paper3.pipeline import corpus, generate, subfields

OUT = Path("paper3/data/questions/questions_v1.jsonl")
...
def main() -> None:
    ...
    summary = Path("paper3/data/questions/generation_summary.json")
