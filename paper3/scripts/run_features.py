...
Produces paper3/data/features/features_v1.jsonl (committed), one record per
...
from paper3.pipeline import corpus, features

QUESTIONS = Path("paper3/data/questions/questions_v1.jsonl")
OUT = Path("paper3/data/features/features_v1.jsonl")
