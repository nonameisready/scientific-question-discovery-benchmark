...
table, and writes all results to paper3/results/:
...
from paper3.pipeline import analysis, models

QUESTIONS = Path("paper3/data/questions/questions_v1.jsonl")
FEATURES = Path("paper3/data/features/features_v1.jsonl")
LABELS = Path("paper3/data/labels/labels_v1.jsonl")
RESULTS = Path("paper3/results")
